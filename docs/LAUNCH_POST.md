...
The next priorities are a more production-oriented framework adapter, a polished launch GIF, and feedback from people building real tool-using agents, RAG workflows, MCP servers, or agent CI checks.
