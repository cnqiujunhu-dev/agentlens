...
The next priorities are a first public release tag, a public GitHub repository, and feedback from people building real tool-using agents, RAG workflows, MCP servers, or agent CI checks.
