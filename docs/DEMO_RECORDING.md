...
| 22-40s | Support dashboard | Security Scan panel, timeline, costs, latency, final answer, citations |
...
From that trace you can replay the run, run JSON eval rules, scan for leaked secrets, redact sensitive fields, fail CI, and generate static dashboards for issues or pull requests.
