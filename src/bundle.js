...
import { ensureDir, readTrace, writeText } from "./store.js";
...
<body>
  ...
  <main>
    ...
    <footer>Generated by AgentLens. Static bundle, no external assets.</footer>
  </main>
</body>
</html>`;
}
...
export function buildRunBundle({ runsDir = ".agentlens/runs", outDir = ".agentlens/reports/bundle", sections = undefined } = {}) {
  ...
  return {
    runsDir,
    outDir,
    indexHtml: renderRunBundleIndex({ runsDir, items }),
    items,
    dashboards
  };
}
